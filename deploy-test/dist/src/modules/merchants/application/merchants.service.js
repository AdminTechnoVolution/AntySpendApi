...
let MerchantService = class MerchantService extends create_entity_module_1.BaseEntityService {
    constructor(model) {
...
exports.MerchantService = MerchantService = __decorate([
    ...
    __param(0, (0, mongoose_1.InjectModel)(entity_schemas_1.Merchant.name)),

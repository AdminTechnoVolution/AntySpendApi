...
let InvestmentService = class InvestmentService extends create_entity_module_1.BaseEntityService {
    constructor(model) {
...
exports.InvestmentService = InvestmentService = __decorate([
    ...
    __param(0, (0, mongoose_1.InjectModel)(entity_schemas_1.Investment.name)),

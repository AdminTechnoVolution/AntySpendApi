...
exports.default = () => ({
    ...
    googlePlay: {
        packageName: process.env.GOOGLE_PLAY_PACKAGE_NAME ?? 'com.technovolution.antyspend',
        serviceAccountJsonBase64: process.env.GOOGLE_PLAY_SERVICE_ACCOUNT_JSON_BASE64 ?? '',
        serviceAccountJson: process.env.GOOGLE_PLAY_SERVICE_ACCOUNT_JSON ?? '',
    },
    rtdn: {
        enabled: process.env.RTDN_ENABLED === 'true' || process.env.RTDN_ENABLED === '1',
        skipAuth: process.env.RTDN_SKIP_AUTH === 'true' ||
    ...
    enableSwagger: process.env.ENABLE_SWAGGER === 'true' || process.env.ENABLE_SWAGGER === '1',
});

...
__decorate([
    (0, common_1.Get)(),
    (0, crud_swagger_decorator_1.ApiCrudList)('recurring expenses', entity_dto_1.RecurringExpenseDto),
...
__decorate([
    (0, common_1.Post)(),
    (0, crud_swagger_decorator_1.ApiCrudCreate)('recurring expense', entity_dto_1.CreateRecurringExpenseDto, entity_dto_1.RecurringExpenseDto),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Mark recurring expense as paid and advance next due date' }),
    (0, swagger_1.ApiParam)({ name: 'id', description: 'Recurring expense id' }),
    ...
    __metadata("design:paramtypes", [Object, String]),
    __metadata("design:returntype", void 0)
], RecurringExpenseController.prototype, "markPaid", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object, String]),
    __metadata("design:returntype", void 0)
], RecurringExpenseController.prototype, "remove", null);
exports.RecurringExpenseController = RecurringExpenseController = __decorate([
    ...
    __metadata("design:paramtypes", [recurringExpenses_service_1.RecurringExpenseService])
], RecurringExpenseController);
//# sourceMappingURL=recurringExpenses.controller.js.map
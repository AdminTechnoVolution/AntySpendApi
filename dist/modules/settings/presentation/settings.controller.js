...
const settings_service_1 = require("../application/settings.service");
...
__decorate([
    ...
    (0, swagger_1.ApiOkResponse)({ type: entity_dto_1.UserSettingsDto }),
...
__decorate([
    ...
    (0, swagger_1.ApiBody)({ type: entity_dto_1.UpdateUserSettingsDto }),
    (0, swagger_1.ApiOkResponse)({ type: entity_dto_1.UserSettingsDto }),
    (0, common_responses_decorator_1.ApiStandardAuthResponses)(),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),

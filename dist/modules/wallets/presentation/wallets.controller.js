...
__decorate([
    (0, common_1.Get)(),
    (0, crud_swagger_decorator_1.ApiCrudList)('wallets', entity_dto_1.WalletDto),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, crud_swagger_decorator_1.ApiCrudGet)('wallet', entity_dto_1.WalletDto),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
...
__decorate([
    (0, common_1.Post)(),
    (0, crud_swagger_decorator_1.ApiCrudCreate)('wallet', entity_dto_1.CreateWalletDto, entity_dto_1.WalletDto),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
...
__decorate([
    (0, common_1.Patch)(':id'),
    (0, crud_swagger_decorator_1.ApiCrudUpdate)('wallet', entity_dto_1.UpdateWalletDto, entity_dto_1.WalletDto),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __param(1, (0, common_1.Param)('id')),
...
__decorate([
    ...
    (0, crud_swagger_decorator_1.ApiCrudDelete)('wallet', entity_dto_1.WalletDto),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __param(1, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String]),

...
__decorate([
    (0, common_1.Get)(),
    (0, crud_swagger_decorator_1.ApiCrudList)('categories', entity_dto_1.CategoryDto),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, crud_swagger_decorator_1.ApiCrudGet)('category', entity_dto_1.CategoryDto),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
...
__decorate([
    (0, common_1.Post)(),
    (0, crud_swagger_decorator_1.ApiCrudCreate)('category', entity_dto_1.CreateCategoryDto, entity_dto_1.CategoryDto),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
...
__decorate([
    (0, common_1.Patch)(':id'),
    (0, crud_swagger_decorator_1.ApiCrudUpdate)('category', entity_dto_1.UpdateCategoryDto, entity_dto_1.CategoryDto),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __param(1, (0, common_1.Param)('id', parse_entity_id_pipe_1.ParseEntityIdPipe)),
...
__decorate([
    ...
    (0, crud_swagger_decorator_1.ApiCrudDelete)('category', entity_dto_1.CategoryDto),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __param(1, (0, common_1.Param)('id', parse_entity_id_pipe_1.ParseEntityIdPipe)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String]),

...
__decorate([
    (0, common_1.Get)(),
    (0, crud_swagger_decorator_1.ApiCrudList)('investments', entity_dto_1.InvestmentDto),
...
__decorate([
    (0, common_1.Post)(),
    (0, crud_swagger_decorator_1.ApiCrudCreate)('investment', entity_dto_1.CreateInvestmentDto, entity_dto_1.InvestmentDto),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
...
exports.InvestmentController = InvestmentController = __decorate([
    ...
    __metadata("design:paramtypes", [investments_service_1.InvestmentService])
